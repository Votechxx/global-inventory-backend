...
export class InventoryController {
  ...
  @Post()
  createInventory(@Body() createInventoryDto: CreateInventoryDto, @GetUser() user: User) {
    return this.inventoryService.createInventory(createInventoryDto, user.id);
  }
  ...
  async updateInventory(
    ...
    return this.inventoryService.updateInventory(+id, updateInventoryDto, user.id);
  }
  ...
  @Delete(':id')
  deleteInventory(@Param('id') id: number, @GetUser() user: User) {
    return this.inventoryService.deleteInventory(+id, user.id);
  }
  ...
  async addProduct(
    ...
    return this.inventoryService.addProductToInventory(+id, addProductDto, user.id);
  }
  ...
  async addWorker(
    ...
    return this.inventoryService.addWorkerToInventory(+id, addWorkerDto, user.id);
  }
}